...
class Student extends CI_Controller {
    ...
    public function search()
    {
        ...
        $config['base_url'] = base_url().$this->uri->segment(1).'/search';
        ...
        $link = str_replace($config['base_url'],"filter('".$config['base_url']."",$link);
        $link = str_replace('" data-ci','\')" data-ci',$link);   
        $link = str_replace('href','onclick',$link);   
        // echo "<pre>"; 
        // echo "<code>"; 
        // var_dump($link); 
        ...
        $data['students'] = $this->model->get_all($config["per_page"],$page,$search);
